...
export function CountdownWidget({ assignments = [], lastUpdated = '', widgetSize = 'medium', isPremium = false }: WidgetProps) {
                ...
                assignments.map((item, index) => (
                    <FlexWidget
                        ...
                        style={{
                            ...
                            backgroundColor: isPremium ? '#f5f3ff' : (item.daysRemaining <= 3 ? '#fef2f2' : '#f8fafc'),
                            borderRadius: 8,
                            paddingHorizontal: 8,
                            paddingVertical: 0,
                            height: itemHeight,
                            borderWidth: 1,
                            borderColor: isPremium ? '#ddd6fe' : (item.daysRemaining <= 3 ? '#fecaca' : '#e2e8f0'),
                        }}
                    >
                        ...
                        <FlexWidget
                            style={{
                                backgroundColor: item.daysRemaining <= 1 ? '#ef4444' : (item.daysRemaining <= 3 ? '#f59e0b' : (isPremium ? premiumColor : '#3b82f6')),
                                borderRadius: 12,
                                paddingHorizontal: 6,
                                paddingVertical: 2,
                                justifyContent: 'center',
