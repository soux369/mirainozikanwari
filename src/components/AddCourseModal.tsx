...
const AddCourseModal: React.FC<AddCourseModalProps> = ({ visible, onClose, onSave, onDelete, initialData, isDarkMode = false, onOpenShare, onOpenImport }) => {
    ...
    const handleSave = () => {
        if (formData.name && formData.day && formData.period) {
            ...
            Alert.alert("エラー", "授業名、曜日、時限は必須です");
        }
    };
            ...
            >
                ...
                <View style={[styles.modalContent, { backgroundColor: bg }]}>
                    ...
                    <View style={styles.header}>
                        ...
                        <Text style={[styles.title, { color: textPrimary }]}>{initialData?.id ? '授業の編集' : '授業の追加'}</Text>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                        ...
                        <View style={styles.section}>
                            <Text style={[styles.label, { color: textSecondary }]}>基本情報</Text>
                        ...
                        {/* Day & Period */}
                        <View style={styles.section}>
                            <Text style={[styles.label, { color: textSecondary }]}>時間割</Text>
                        ...
                        {/* Details */}
                        <View style={styles.section}>
                            <Text style={[styles.label, { color: textSecondary }]}>詳細情報</Text>
                            <View style={styles.row}>
                        ...
                        {/* Color Picker */}
                        <View style={styles.section}>
                            <Text style={[styles.label, { color: textSecondary }]}>テーマカラー</Text>
