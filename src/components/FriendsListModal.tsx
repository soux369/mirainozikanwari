        ...
        >
            <View style={[styles.container, { backgroundColor: bgBase }]}>
                ...
                <View style={[styles.header, { borderBottomColor: borderColor }]}>
                    <Text style={[styles.headerTitle, { color: textPrimary }]}>{t.friendsTimetable}</Text>
                ...
                <ScrollView contentContainerStyle={styles.content}>
                    {friends.length === 0 ? (
                        <View style={styles.emptyState}>
                            ...
                            <Text style={[styles.emptyTitle, { color: textPrimary }]}>{t.noFriends}</Text>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <View style={{ flex: 1 }}>
                                            ...
                                            <Text style={{ fontSize: 12, color: textSecondary }}>
                                                {t.classesRegistered(friend.courses.length)}
                                            </Text>
                                        </View>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        onPress={() => {
                                            Alert.alert(
                                                t.deleteFriend,
                                                t.deleteFriendSpecific(friend.name),
                                                [
