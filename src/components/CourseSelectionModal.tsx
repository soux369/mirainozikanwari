...
import { Course, Settings, Day } from '../lib/types';
                ...
                <View style={[styles.container, { backgroundColor: bg }]}>
                    <View style={styles.header}>
                        <Text style={[styles.title, { color: textPrimary }]}>
                            {t.detectedCourses} ({scannedCourses.length})
                        </Text>
                                ...
                                >
                                    ...
                                    <View style={styles.itemContent}>
                                        ...
                                        <Text style={[styles.courseDetails, { color: textSecondary }]}>
                                            {t[item.day]} {item.period}{t.periodSuffix} • {item.room || t.roomUndecided}
                    ...
                    <View style={styles.footer}>
                        ...
                        >
                            <Text style={styles.confirmText}>
                                {t.addWithCount(selectedIds.size)}
                            </Text>
                        </TouchableOpacity>
                    </View>
                </View>
