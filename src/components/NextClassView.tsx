            ...
            <View style={styles.header}>
                ...
                <View style={{ alignItems: 'center' }}>
                    ...
                    <ThemedText style={{ fontSize: 12, color: textSecondary }}>
                        {targetDayStr === 'Holiday' ? t.holiday : (settings.language === 'en' ? t[targetDayStr as Day] : `${t[targetDayStr as Day]}曜日`)}
                    </ThemedText>
                </View>
                            ...
                            >
                                <View style={styles.cardHeader}>
                                    <View style={[styles.periodBadge, { backgroundColor: badgeColor }]}>
                                        <ThemedText style={[styles.periodBadgeText, { color: badgeTextColor }]}>{course.period}{t.periodSuffix}</ThemedText>
                                    </View>
                                    <View style={styles.timeInfo}>
                                        {course.room ? (
                                            ...
                                            <ThemedText style={[styles.roomText, { color: isDarkMode ? '#94a3b8' : '#64748b' }]}>{t.roomUndecided}</ThemedText>
                                        )}
                                    </View>
                                </View>
